...
ALTER TABLE signup_checkpoints
    ...
    ADD COLUMN user_provided_name INT REFERENCES user_name (id),
...
ALTER TABLE "user"
    ADD CONSTRAINT FK_User_Other_Nationality FOREIGN KEY (other_nationality) REFERENCES country (iso);
...
ALTER TABLE "user"
    ADD CONSTRAINT CHK_User_Other_Nationality
        CHECK (
            (nationality = 'OTHER' AND other_nationality IS NOT NULL)
                OR
...
ALTER TABLE "user"
    ...
    ADD CONSTRAINT FK_User_Correspondence_Address FOREIGN KEY (correspondence_address_id) REFERENCES address (id);

ALTER TABLE signup_checkpoints
    ADD COLUMN correspondence_address_id INT,
    ADD CONSTRAINT FK_Checkpoint_Correspondence_Address FOREIGN KEY (correspondence_address_id) REFERENCES address (id);
